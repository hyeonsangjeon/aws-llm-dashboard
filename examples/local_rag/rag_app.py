...
if 'vector_index' not in st.session_state:
    with st.spinner("Indexing document..."):
        pdf_path = os.path.join(os.path.dirname(__file__), "Amazon-com-Inc-2023-Shareholder-Letter.pdf")
...
input_text = st.text_area("Input text", value="아마존 실적에 대해 알려줘", label_visibility="collapsed")
